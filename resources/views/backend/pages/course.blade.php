...
<div class="p-6 sm:p-8 w-full max-w-7xl mx-auto font-sans text-slate-800 relative">
    ...
    <div class="flex flex-col md:flex-row justify-between gap-4 mb-6">
        ...
        <select class="w-full md:w-48 px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-600 focus:ring-2 focus:ring-indigo-500 outline-none cursor-pointer">
            <option value="">All Categories</option>
            <option value="upsc">9th & 10th Foundation</option>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col">
            ...
            <div class="relative h-48 overflow-hidden">
                ...
                <!-- Category -->
                <div class="absolute top-3 right-3 bg-white/90 backdrop-blur-sm text-slate-800 text-xs font-bold px-2.5 py-1 rounded-md shadow-sm">
        ...
        <div class="p-6 max-h-[75vh] overflow-y-auto custom-scrollbar">
            <form action="{{ route('course.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Mode of Delivery</label>
                        <select name="mode"
                            class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500 outline-none cursor-pointer">
                            <option value="online">Online Live</option>
                            <option value="offline">Offline / Classroom</option>
                            <option value="hybrid">Hybrid</option>
                            <option value="recorded">Recorded VOD</option>
                        </select>
                    </div>
